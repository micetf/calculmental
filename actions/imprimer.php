...
class PDF extends FPDF
{
  ...
  var $correction=false;
	...
	function setReferences($niveau,$numero)
	{
		$this->niveau = $niveau;
		$this->numero = $numero;
	}
	...
	function afficherDonnees($fiche)
	{
	...
	function afficherReponses($fiche)
	{
	    $this->SetFont('Arial','',12);
		foreach ($fiche as $ligne) {
			$l=190/count($ligne);
    ...
    $this->Image('../common/logos/CreativeCommons80x15.png',180,282,20,4,'png','http://creativecommons.org/licenses/by-nc/2.0/fr/');
	}
}
