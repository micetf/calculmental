...
{
    public $nomCompteur;
    public $nomCompteurLive;
    public $nbVisiteurs;
    public $nbVisiteursLive;
    public $cookie;

    public function Visiteur($nomCompteur)
    {
        ...
        $this->lireCompteur();
        if ($this->isRobot() === false && !isset($_COOKIE[$this->cookie])) {
    ...
    public function ecrireCompteur()
    {
    ...
    public function ecrireCompteurLive()
    {
